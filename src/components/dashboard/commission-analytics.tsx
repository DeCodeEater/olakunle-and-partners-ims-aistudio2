  ...
  return (
    <div className="bg-pure-surface border border-whisper-border rounded-lg p-6 lg:p-8 flex flex-col">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h3 className="font-headline text-xl text-deep-slate uppercase tracking-tight font-medium">Commission Analytics</h3>
          <p className="font-mono text-[10px] text-muted-steel uppercase mt-2 tracking-widest font-medium">Facilitator Performance Matrix</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        <div className="border border-whisper-border rounded-md p-4 text-center transition-all hover:bg-surface-container-low/50 hover:border-slate-300">
          <p className="text-[9px] text-muted-steel uppercase font-mono mb-2 tracking-widest font-medium">Total Paid (YTD)</p>
          <p className="font-mono font-bold text-[18px] text-deep-slate">₦84.2M</p>
        </div>
        <div className="border border-whisper-border rounded-md p-4 text-center transition-all hover:bg-surface-container-low/50 hover:border-slate-300">
          <p className="text-[9px] text-muted-steel uppercase font-mono mb-2 tracking-widest font-medium">Pending</p>
        ...
        <div className="border border-whisper-border/50 rounded-md p-4 text-center bg-surface-container-low transition-colors hover:bg-surface-dim/70">
          <p className="text-[9px] text-muted-steel uppercase font-mono mb-2 tracking-widest font-medium">Avg Conv.</p>
      ...
      <div className="flex-grow flex flex-col">
        <div className="flex justify-between items-end border-b border-whisper-border pb-3 mb-2 mt-auto">
          <h4 className="font-mono text-[11px] font-bold text-deep-slate uppercase tracking-widest">
            Top Facilitators
          </h4>
          <span className="text-[9px] font-mono text-muted-steel uppercase tracking-widest">This Quarter</span>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr>
                <th className="py-3 px-2 font-mono text-[10px] text-muted-steel uppercase font-medium tracking-widest">Agent</th>
                <th className="py-3 px-2 font-mono text-[10px] text-muted-steel uppercase font-medium tracking-widest text-right">Deals</th>
                <th className="py-3 px-2 font-mono text-[10px] text-muted-steel uppercase font-medium tracking-widest text-right">Volume</th>
                <th className="py-3 px-2 font-mono text-[10px] text-muted-steel uppercase font-medium tracking-widest text-right">Earned</th>
              </tr>
            </thead>
