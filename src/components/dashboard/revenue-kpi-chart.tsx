        ...
        <div className="relative z-10 flex-grow w-full h-[60px] min-h-[60px] -mx-1 mt-2 mb-2">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
              <Tooltip cursor={{fill: '#f1f5f9'}} contentStyle={{ backgroundColor: '#141f30', border: 'none', borderRadius: '4px', fontSize: '10px', color: '#fff', padding: '4px' }} itemStyle={{ color: '#fff' }} />
              <Bar dataKey="value" fill="#0f172a" radius={[2, 2, 0, 0]} maxBarSize={30} />
            </BarChart>
          </ResponsiveContainer>
        </div>
