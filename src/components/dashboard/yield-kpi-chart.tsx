...
export function YieldKpiChart() {
  ...
  return (
    <Link
      href="/finance/reports?view=yield"
      title="View financial reports with portfolio yield breakdown"
    >
      <div className="group border border-whisper-border p-fluid-s rounded-lg bg-pure-surface shadow-whisper hover:shadow-whisper-hover hover:bg-slate-50 cursor-pointer transition-all duration-300 flex flex-col justify-between h-full relative overflow-hidden">
        ...
        <div className="relative z-10 font-mono font-bold text-fluid-2xl text-amber-500 mb-1 tracking-tight">
          8.4%
        </div>

        <div
          className="relative z-10 flex-grow w-full h-[60px] min-h-[60px] -mx-1 mt-2 mb-2"
          title="Below target by 0.6% — 3M trend: declining"
        >
