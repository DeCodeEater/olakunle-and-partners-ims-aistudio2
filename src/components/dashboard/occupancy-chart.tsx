  ...
  return (
    <div className="group border border-whisper-border p-fluid-s rounded-lg bg-pure-surface shadow-whisper hover:shadow-whisper-hover transition-all duration-300 flex flex-col justify-between h-full relative overflow-hidden">
      ...
      <div className="relative z-10 flex justify-between items-start mb-fluid-xs">
        <span className="font-mono text-[11px] sm:text-fluid-xs text-muted-steel uppercase block tracking-widest font-medium transition-colors">Occupied vs Vacant</span>
        ...
        <div className="relative w-full h-full flex items-center gap-4">
           ...
           <div className="flex flex-col gap-1.5 justify-center">
             <div className="flex items-center gap-2">
               ...
               <span className="font-mono text-[10px] text-deep-slate font-bold tracking-widest uppercase">87 Units Occ.</span>
             </div>
             <div className="flex items-center gap-2">
               <div className="w-2 h-2 rounded-sm bg-whisper-border"></div>
               <span className="font-mono text-[10px] text-muted-steel tracking-widest uppercase">13 Units Vac.</span>
             </div>
           </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mt-fluid-xs pt-fluid-3xs border-t border-whisper-border/50 relative z-10">
        <span className="text-[10px] text-muted-steel uppercase font-mono tracking-widest">Lease Efficiency</span>
